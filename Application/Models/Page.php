...
class Page extends Model{
    ...
    public static function findAllMain()
    {
        ...
        $res = $db->query('SELECT * FROM ' . static::TABLE . ' WHERE is_main = "1" AND is_active = "1" ORDER BY id', static::class);
        return $res;
    }
    ...
    public static function findByIdCategory($id_category){
        $db = Db::instance();
        $res = $db->query('SELECT * FROM ' . static::TABLE . ' WHERE id_parent = :id_category', static::class, [':id_category' => $id_category]);
        return $res;
    }
