    ...
    <?php if ($pagination): ?>
        <div class="pager clearfix">
            <?php if ($pagination->showPrev()): ?>
                <p class="previous-link">&larr; <a href="/index.php?controller=main&action=index&page=<?=$this->prev;?>">Previous</a></p>
            <?php endif; ?>
            <?php if ($pagination->showNext()): ?>
                <p class="next-link"> <a href="/index.php?controller=main&action=index&page=<?=$this->next;?>">Next</a>&rarr;</p>
             <?php endif; ?>
        </div>
    <?php endif; ?>
</div>
